...
class Product(models.Model):
    ...
    def discount_naira(self):                          return self.discount*self.to_naira()/100
    def discounted_amount(self):
        return self.to_naira() - self.discount_naira()
...
class Address(models.Model):
    ...
    apartment_address = models.CharField(max_length=50, default="Nigeria")
