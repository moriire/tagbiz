        ...
        <div class="row">
          <div class="col-lg-7 col-md-12 col-12">
            <table class="cart-table w-100">
              ...
              <tbody v-if="prod.cartItems.length>0">
                <tr class="cart-item" v-for="(cart, index) in prod.cartItems" v-bind:key="index">
                  ...
                  <td class="cart-item-details">
                    <h2 class="product-title"><RouterLink :to="{name: 'product-detail', params: { product: cart.id} }">{{ cart.name }}</RouterLink></h2>
              ...
              <h2 v-else>
                Your cart is empty. <RouterLink to="/shop">Browse products</RouterLink>
              </h2>
            </table>
          </div>
