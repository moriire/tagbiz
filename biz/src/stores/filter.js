...
export const useFilterStore = defineStore('filter', () => {
  ...
  const page = reactive({pageCount: 1, totalPages: products.length, start: 0, next:function(){ return this.pageSize*this.pageCount}, pageSize: 1, fstate: "", pstate: "disabled"})
